...
class BIBTEX(CatalogPlugin):
    ...
    def run(self, path_to_output, opts, db, notification=DummyReporter()):
        ...
        def create_bibtex_entry(entry, fields, mode, template_citation,
            ...
            for field in fields:
                ...
                if field == 'authors' :
                    ...
                    bibtex_entry.append('{} = "{} octets"'.format(field, int(item)))
                    ...
                    bibtex_entry.append('{} = "{}"'.format(field, bibtexdict.utf8ToBibtex(item)))
        ...
        if opts.verbose:
            opts_dict = vars(opts)
            log("{}(): Generating {}".format(self.name,self.fmt))
            ...
            log(" Output file will be encoded in {} with {} flag".format(bibfile_enc, bibfile_enctag))
