...
class Document:
    ...
    def score_paragraphs(self, ):
        ...
        for elem in ordered:
            ...
            self.debug("Candid: {:6.3f} {} link density {:.3f} -> {:6.3f}".format(score, describe(elem), ld, score*(1-ld)))
        ...
        for el in self.reverse_tags(node, "table", "ul", "div"):
            ...
            if weight + content_score < 0:
                ...
                if counts["p"] and counts["img"] > counts["p"]:
                    ...
                    reason = "too many links {:.3f} for its weight {}".format(link_density, weight)
                    to_remove = True
